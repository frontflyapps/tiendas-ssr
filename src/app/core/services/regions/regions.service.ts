...
export class RegionsService {
  ...
  removeRegion(data: any): Promise<any> {
    return this.httpClient
      .delete<any>(this.urlId.replace(':regionId', data.id), this.httpOptions)
      .toPromise();
  }
  ...
  removeCity(data: any): Promise<any> {
    return this.httpClient
      .delete<any>(this.urlCityId.replace(':id', data.id), this.httpOptions)
      .toPromise();
  }
